  ...
  <div class="home-category" @mouseleave="categoryId=null">
    <ul class="menu">
      ...
      >
        ...
        <span v-else>
            <XtxSkeleton width="60px" height="18px" style="margin-right:5px" bg="bg=rgba(255,255,255,0)"></XtxSkeleton>
             <XtxSkeleton  width="50px" height="18px" bg="bg=rgba(255,255,255,0.2)"></XtxSkeleton>
        </span>
      </li>
    </ul>
  </div>
